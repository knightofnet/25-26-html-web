...
- [Bilan TD1 + TD2 — Ce que vous devez maîtriser](#bilan-td1--td2--ce-que-vous-devez-ma%C3%AEtriser)
    - [HTML : à quoi ça sert, et ce que c’est vraiment](#html--%C3%A0-quoi-%C3%A7a-sert-et-ce-que-cest-vraiment)
        - [Exemple structure minimale](#exemple-structure-minimale)
        - [Les balises HTML](#les-balises-html)
        - [Remarques](#remarques)
        - [Code source vs rendu / ce que vous voyez à l’écran](#code-source-vs-rendu--ce-que-vous-voyez-%C3%A0-l%C3%A9cran)
        - [Le cycle de travail : modifier → rafraîchir → observer](#le-cycle-de-travail--modifier-%E2%86%92-rafra%C3%AEchir-%E2%86%92-observer)
        - [Autres ressources sur le WEB](#autres-ressources-sur-le-web)
...
- `<a href="URL">...</a>` : lien hypertexte. [Sur CELENE : 2d. HTML : Créer des liens](https://celene.univ-tours.fr/mod/resource/view.php?id=902393)
  - L'attribut `href` indique l'URL de destination du lien - "vers où on va" - lorsqu'on clique dessus.
- `<img src="URL" alt="description" />` : image. [Sur CELENE : 2e. HTML : Insérer des images](https://celene.univ-tours.fr/mod/resource/view.php?id=902394)
  - L'attribut `src` indique l'URL de l'image à afficher.
  - L'attribut `alt` fournit une description textuelle de l'image, utile pour l'accessibilité et lorsque l'image ne peut pas être chargée.
...
<body>
    ...
    <p>
        ...
        <strong>eget</strong> vehicula <sub>turpis</sub> gravida. Fusce eleifend blandit semper. Quisque lacinia finibus nisi ut
    ...
    <!-- Les Tableaux-->
    <table border="1">
        <!-- l'attribut border est optionnel, il sert à afficher les bordures du tableau -->
        <!-- On le mets ici juste pour la visibilité dans cet exemple, on préfère utiliser CSS pour la mise en forme -->

        
        <tr>
            <th>Ligne 1, colonne 1</th>
            <th rowspan="2">Ligne 1, colonne 2</th>
        </tr>
