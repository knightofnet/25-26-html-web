...
- [Bilan TD1 + TD2 — Ce que vous devez maîtriser](#bilan-td1--td2--ce-que-vous-devez-ma%C3%AEtriser)
    - [Utiliser un serveur web local](#utiliser-un-serveur-web-local)
        - [Avec XAMPP sous Windows](#avec-xampp-sous-windows)
        - [Ce que vous devez savoir faire procédure générale](#ce-que-vous-devez-savoir-faire-proc%C3%A9dure-g%C3%A9n%C3%A9rale)
        - [Avec un serveur web local sur Linux Ubuntu](#avec-un-serveur-web-local-sur-linux-ubuntu)
        - [Avec Docker sur Linux et MacOS/Windows - Plus complexe](#avec-docker-sur-linux-et-macoswindows---plus-complexe)
