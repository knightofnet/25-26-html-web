...
if (!empty($_POST)) {
    ...
    // On récupère le nom; s'il n'est pas défini, on lui affecte une valeur par défaut (une chaîne vide dans notre cas)
    $nom = isset($_POST['nom']) ? $_POST['nom'] : '';
    // Si le nom n'est pas vide, on réalise l'insertion du joueur dans la base de données, sinon on affiche un message d'erreur
    if (!empty($nom)) {
